        ...
        <div className="flex">
          <div className=" pt-2">
            {userName !== null || adminName !== null ? (
              <div className="flex ">
                <div
                  className="font-medium cursor-pointer text-xl hover:bg-white"
                ...
                <div
                  ...
                  className="ml-4 font-medium cursor-pointer text-xl hover:bg-white"
                >
                  LOGOUT
                </div>
              </div>
            ) : (
              <Link to="/register" className="font-medium mt-16 ml-24 text-2xl hover:bg-white">
                SIGN IN
              </Link>
            )}
          </div>
